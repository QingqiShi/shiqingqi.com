...
import * as utils from './color_utils.ts';
import * as math from './math_utils.ts';
...
export class ViewingConditions {
  ...
  private constructor(
      n: number, aw: number, nbb: number,
      ncb: number, c: number, nc: number,
      rgbD: number[], fl: number, fLRoot: number,
      z: number) {
    this.n = n;
    this.aw = aw;
    this.nbb = nbb;

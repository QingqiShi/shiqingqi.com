...
const styles = stylex.create({
  ...
  detailsBackdrop: {
    ...
    backgroundImage: `linear-gradient(
        to bottom left,
        rgba(${color.backgroundChannels}, 0.7) 0%,
        rgba(${color.backgroundChannels}, 0.691) 4.05%,
        rgba(${color.backgroundChannels}, 0.666) 7.75%,
        rgba(${color.backgroundChannels}, 0.627) 11.2%,
        rgba(${color.backgroundChannels}, 0.577) 14.45%,
        rgba(${color.backgroundChannels}, 0.519) 17.5%,
        rgba(${color.backgroundChannels}, 0.454) 20.5%,
        rgba(${color.backgroundChannels}, 0.385) 23.35%,
        rgba(${color.backgroundChannels}, 0.315) 26.25%,
        rgba(${color.backgroundChannels}, 0.246) 29.15%,
        rgba(${color.backgroundChannels}, 0.181) 32.15%,
        rgba(${color.backgroundChannels}, 0.123) 35.25%,
        rgba(${color.backgroundChannels}, 0.073) 38.55%,
        rgba(${color.backgroundChannels}, 0.034) 42.1%,
        rgba(${color.backgroundChannels}, 0.009) 45.9%,
        rgba(${color.backgroundChannels}, 0) 50%
      )`,
    content: "",
    position: "absolute",
    top: 0,

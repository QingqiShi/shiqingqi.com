...
/**
 * Sub-cell guide positions as fractional offsets in `[0, 1]` along an axis —
 * callers convert to source-pixel or canvas-pixel space.
 *
 * Vertical lines (offsets along x) and horizontal lines (offsets along y) are

...
export default function NottinghamLogo({ title }: NottinghamLogoProps) {
  return (
    <svg viewBox="0 0 115.79 170" css={styles.svg}>
      <title>{title}</title>
      <g>
        <path
...
const styles = stylex.create({
  svg: {
    ...
    color: stylex.firstThatWorks(svgTokens.fill, brand.nottingham),
    fill: "currentColor",
    objectFit: "contain",
    width: "100%",
    height: "100%",

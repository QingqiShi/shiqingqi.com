...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  return designSystemMetadata({
    ...
    description: t({
      en: "Headless React hooks — controlled state, dialog focus, anchored popover placement, tactile press, and roving-tabindex radiogroups — the behavioural half of the custom layer.",
      zh: "无头 React 钩子——受控状态、对话框焦点、锚定弹出层定位、触感按压与 roving-tabindex 单选组——自定义层中负责行为的一半。",
    }),
  });
}
  ...
  return (
    <DocPage
      ...
      description={t({
        ...
        zh: "自定义层的行为，与外观解耦。这些无头钩子承担了棘手的部分——受控/非受控状态、焦点困陷、视口感知的定位、按压物理与可访问的键盘模型——让自定义控件无需继承任何外观定见即可借用这些保证。",
      })}
    >
      <HooksShowcase />
    </DocPage>

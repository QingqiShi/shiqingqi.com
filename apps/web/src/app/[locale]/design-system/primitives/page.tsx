...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  return designSystemMetadata({
    ...
    description: t({
      en: "Composable StyleX primitives — flex, layout, motion, reset, and accessibility — for the custom layer, when a page needs to compose its own thing below the components.",
      zh: "可组合的 StyleX 原语——flex、布局、动效、重置与无障碍——面向自定义层，当页面需要在组件之下自行组合时使用。",
    }),
  });
}
  ...
  return (
    <DocPage
      ...
      description={t({
        ...
        zh: "自定义层的构建块：当没有组件契合时，你可以直接组合的多属性 StyleX 原语。每个都封装了一组常见属性——flex 布局、定位填充、动效预设、重置与无障碍辅助——让定制表面仍能继承系统默认值，而无需手写 CSS。",
      })}
    >
      <PrimitivesShowcase />
    </DocPage>

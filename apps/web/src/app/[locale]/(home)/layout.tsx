...
const styles = stylex.create({
  ...
  glow: {
    ...
    overflow: "hidden",
    pointerEvents: "none",
    backgroundImage: `radial-gradient(circle calc(${glowTokens.height}*5) at center calc(${glowTokens.height}*5), ${color.bgAccentSubtle} calc(${glowTokens.height}*4), transparent)`,

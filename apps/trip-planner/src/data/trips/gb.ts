  ...
  },
  {
    ...
    nav: [
      ...
      },
      {
        ...
        mode: "driving",
        note: "A82 → A74(M) → M6 一路向南约 4h 直达午餐点 Tebay；沿途每停一次服务区按 +30min 算。今天首停已花 30min，Tebay 预计约 15:50 到、比原计划晚约 50min。",
        time: "11:00",
        durationMin: 240,
      },
      {
    ...
    timeline: [
      ...
      {
        time: "15:50",
        text: "Tebay Services 午餐 + 加油（留足约 45min，别赶）；首停花了 30min，预计约 15:50 到、比原计划晚约 50min。早饿了就在 Green Welly（Tyndrum，约 11:45）先垫一顿",
        optional: true,
        durationMin: 45,
      },
      {
        time: "17:10",
        text: "抵达温德米尔，入住 Woodlands B&B、放下行李（含 Tebay 这一长停，约 17:10 前后到；路途确实长）",
      },
      {
        time: "17:15",
        text: "Bowness 逛礼品店（Jim 最爱）+ Windermere 的 Lakeland 旗舰店 — 今天到得晚，购物窗口压到约 17:15–18:00，先紧着 Jim 最在意的几家逛；18:45 Henrock 已订位，18:00 务必收尾回去梳洗",
        optional: true,
        durationMin: 45,
      },
      {
    ...
    tips: [
      ...
      {
        kind: "warn",
        text: "服务区比想象中耗时间：每停一次按 30min 留量，别按 15min 估。今天首停已花 30min，到 Tebay 已晚约 50min——之后若再停，购物窗口继续压缩，但 18:45 Henrock 订位不能动。",
        time: "11:00",
      },
      {
        kind: "fuel",
      ...
      lodging: [
        {
          ...
          checkIn: "6.24 周三 14:00 起（当天约 17:10 到）",
          checkOut: "6.25 周四 09:00–10:30",
          room: "3 间房 · 3 人",
          note: "Booking.com Genius ★★★★，传统英式 B&B，步行可达湖边。从苏格兰长途南下、加上沿途服务区休息，预计约 17:10 到，晚于 14:00 的最早入住时间。",
          status: "booked",
        },
      ],
    },
  },
  {
    ...
    nav: [
      ...
      },
      {
        ...
        mode: "driving",
        note: "约 2h 直达；M6 上想停服务区（加油 / 休息）就按 +30min 算，所以 16:15 前出发，给 19:00 的订位留余量。",
        time: "16:15",
        durationMin: 120,
      },
    ],
    timeline: [
      ...
      { time: "13:00", text: "午餐", optional: true, durationMin: 60 },
      {
        time: "14:30",
      ...
      {
        time: "16:15",
        text: "出发前往伯明翰；M6 服务区若要停（加油 / 休息）按 +30min 预留，别压到 19:00 的订位。落后就先保证准点到，路上的可选停留随时砍掉",
      },
      {
        time: "18:30",

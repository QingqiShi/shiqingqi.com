    ...
    places: [
      {
        ...
        query: "Glenfiddich Distillery",
        note: "主访 · 随到随品｜Whisky Lounge 9:30–17:00、Malt Barn 酒吧可点单杯与品鉴套杯，司机有无酒精选项；大商店含酒厂限定瓶。无需预约。",
        time: "11:00",
      },
      {
        name: "Speyside Cooperage",
        query: "Speyside Cooperage, Dufftown Road, Craigellachie AB38 9RS",
        note: "不喝酒备选 · 司机首选｜全英唯一可看制桶师现场箍桶，含 4D 影片、商店与木桶主题咖啡馆。周一–周五 9:00–15:00 整点出发，须预约。",
        time: "13:30",
      },
      {
        name: "Glen Grant Distillery & Garden",
        query: "Glen Grant Distillery, Rothes AB38 7BS",
        note: "备选 · 维多利亚花园｜商店 + 品鉴区，40 分钟导览约 £10（含两款品鉴，需预约）。花园近期翻修，去前查官网是否开放。",
        time: "13:30",
      },
      {
        name: "Tomatin Distillery",
        query: "Tomatin Distillery, Tomatin IV13 7YT",
        note: "返程顺路 · 随到随品｜A9 南距因弗内斯 16 英里，吧台免费试一杯 Tomatin 12，商店可自助灌装单桶限定。7 天营业，无需预约。",
        time: "16:30",
      },
      {
        name: "The Singleton of Glen Ord",
        query: "Singleton of Glen Ord Distillery, Muir of Ord IV6 7UJ",
        note: "离因弗内斯最近备选（约 15 英里，往天空岛方向顺路）｜2022 新参观中心得奖，吧台可试 dram 与鸡尾酒、有 deli 与商店买瓶。5–8 月 10:00–18:00。",
      },
      {
        name: "The Macallan Distillery",
        query: "The Macallan Distillery",
        note: "原计划主访，仅限预约 · 未约到｜参观与顶级品鉴须提前网上预约；可去商店看瓶 / 买瓶，但无随到随品吧台。",
      },
      {
        name: "Aberlour Distillery",
        query: "Aberlour Distillery",
        note: "原计划主访，限 8 人 · 未约到｜雪莉桶品鉴仅限预约、当前施工无产线参观；商店可买瓶。",
      },
    ],
    restaurants: [
      {

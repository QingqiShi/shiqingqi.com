...
const days: Day[] = [
  ...
  },
  {
    ...
    nav: [
      ...
      {
        label: "格伦科 → Tyndrum（休息点 1）",
        from: "Three Sisters viewpoint Glencoe",
        to: "The Green Welly Stop, Tyndrum",
        mode: "driving",
        note: "A82 约 45min；Green Welly Stop 是高地经典歇脚点，咖啡 / 洗手间 / 加油 / 商店。不累可直接过",
        time: "11:00",
      },
      {
        label: "Tyndrum → 罗蒙湖 Luss（休息点 2）",
        from: "The Green Welly Stop, Tyndrum",
        to: "Luss, Loch Lomond",
        mode: "driving",
        note: "约 50min；罗蒙湖西岸小村，湖边伸腿、拍张照。可选，不需要就跳过",
        time: "12:00",
      },
      {
        label: "Luss → Abington Services（休息点 3）",
        from: "Luss, Loch Lomond",
        to: "Abington Services, M74, Lanarkshire",
        mode: "driving",
        note: "约 1h；M74 服务区快速上厕所 / 补水。可选，不需要就跳过",
        time: "13:00",
      },
      {
        label: "Abington → Tebay Services（午餐）",
        from: "Abington Services, M74, Lanarkshire",
        to: "Tebay Services southbound, M6, Cumbria",
        mode: "driving",
        note: "约 1h 到 Tebay；就在 M6 路边、离温德米尔约 30min 的农场超市服务区，正经吃顿午餐",
        time: "14:15",
      },
      {
        ...
        mode: "driving",
        note: "午餐后 M6 继续南下约 30min 即到住处；格伦科→温德米尔整段实测约 4h35 / 232mi，上面几个休息点按需取舍",
        time: "15:45",
      },
      {
    ...
    timeline: [
      ...
      {
        time: "11:00",
        text: "上路前往湖区：格伦科 → 温德米尔实测约 4h35 / 232mi（比原以为远得多）。沿途按约 1 小时一个休息点排进了导航分段（Tyndrum → 罗蒙湖 Luss → M74 Abington → Tebay），需要就停、不需要就跳过；午餐定在接近湖区的 Tebay",
      },
      {
        time: "15:00",

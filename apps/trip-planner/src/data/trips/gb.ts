...
const days: Day[] = [
  ...
  },
  {
    ...
    nav: [
      {
        ...
        to: "N17 9LX, London",
        mode: "driving",
        note: "Jim 延误 2h，不必赶早；睡足再出发，先到 N17 接石头上车",
        time: "08:30",
      },
      {
        ...
        mode: "driving",
        note: "Jim 出关后再开进 Short Stay 接人；落地前用「实时追踪」核对到达口",
        time: "08:55",
      },
      {
      ...
      },
      {
        ...
        mode: "transit",
        note: "P&R 巴士进城，撑篙 + 学院（时间紧，主攻康河撑篙）",
        time: "12:00",
      },
      {
    ...
    timeline: [
      {
        time: "08:30",
        text: "从 Chingford 出发（Jim 的航班 CX255 延误约 2h，预计 08:20 落地 T3，可多睡 2h）",
      },
      { time: "08:55", text: "到 N17 接石头上车" },
      { time: "09:55", text: "抵达 Heathrow T3，等 Jim 出关" },
      { time: "10:30", text: "接到 Jim，三人出发，M4 → M25 → M11 北上" },
      {
        time: "12:00",
        text: "剑桥 — 主攻康河撑篙（压缩为约 1.5 小时），学院只来得及外观打卡",
      },
      { time: "13:30", text: "简餐后出发前往诺丁汉" },
      { time: "15:30", text: "抵达诺丁汉，Crowne Plaza 入住" },
      { time: "16:30", text: "沃莱顿大厅 — 蝙蝠侠韦恩庄园取景地，花园散步" },
    ...
    flights: [
      {
        ...
        note: "⚠️ 目前显示延误约 2 小时，预计 08:20 落地（原 06:20）。今早行程已整体顺延约 2h，剑桥相应压缩以保住诺丁汉傍晚；点「实时追踪」盯实时进度，落地有变再微调。",
        time: "08:20",
      },
    ],
    places: [
    ...
    checklists: [
      {
        ...
        items: [
          "出发前给 Jim、石头发实时定位",
          "航班延误约 2h，落地前用「实时追踪」确认到达时间与到达口",
          "Jim（香港护照）走人工通道，预计 10:00–10:30 出关",
    ...
    tips: [
      {
        kind: "parking",
        text: "Heathrow 接机省钱：让 Jim 出关后发消息再开进 Short Stay（£7–17 / 1–1.5h）。航班延误时别提前进场空等，按「实时追踪」的落地时间再出发。",
        time: "09:55",
      },
      {
        kind: "parking",

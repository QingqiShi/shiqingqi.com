...
import { writeFileSyncIfChanged } from "@tuja/codegen-fs";
...
function main(): void {
  ...
  writeFileSyncIfChanged(enPath, JSON.stringify(enMap, null, 2) + "\n");
  writeFileSyncIfChanged(zhPath, JSON.stringify(zhMap, null, 2) + "\n");

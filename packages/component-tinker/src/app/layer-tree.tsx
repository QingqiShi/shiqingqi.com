...
function Row({
  ...
  return (
    <button
      ...
      className={isSelected ? "tk-tree-row tk-tree-row--on" : "tk-tree-row"}
    ...
    >
      ...
      {node.opaque ? (
        <span className="tk-lock" title="Opaque layer, nothing to edit">
          locked
        </span>
      ) : null}
    </button>
...
export function LayerTree({
  ...
  return (
    <div className="tk-tree">
      <label className="tk-cell-select">
        <span className="tk-field-label">cell</span>
        <select
          value={cellIndex}
          onChange={(event) => {

import type { ChangeStore, TokenIndex } from "@tuja/component-tinker";
import {
  BLUR_RADII,
  GLASS_OPACITY_STEPS,
  NONE,
...
export function EffectControls({
  ...
  return (
    <div className="tk-effects">
      {TOGGLE_NAMES.map((name) => (
        <div className="tk-effect" key={name}>
          ...
          {name === "texture" && texture ? (
            <div className="tk-effect-body">
              ...
              <div className="tk-field">
                <span className="tk-field-label">colour</span>
                <TokenField
          ...
          {name === "wash" && wash ? (
            <div className="tk-effect-body">
              ...
              <div className="tk-field">
                <span className="tk-field-label">direction</span>
                <Segmented
                  label="direction"
          ...
          {name === "floating" && floating ? (
            <div className="tk-effect-body">
              <div className="tk-field">
                <span className="tk-field-label">radius</span>
                <Segmented
                  label="radius"
          ...
          {name === "scrollMask" && scrollMask ? (
            <div className="tk-effect-body">
              <div className="tk-field">
                <span className="tk-field-label">axis</span>
                <Segmented
                  label="axis"
          ...
          {name === "glass" && glass ? (
            <div className="tk-effect-body">
              {GLASS_PARTS.map(({ part, opacity }) => (
                <div className="tk-field" key={part}>
                  <span className="tk-field-label">{part}</span>
                  <TokenField
                    property={`glass ${part}`}
                    title={`Glass ${part}`}
                    value={glass[part]}

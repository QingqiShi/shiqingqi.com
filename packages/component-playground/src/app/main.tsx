...
import catalogueJson from "virtual:playground-catalogue";
import configJson from "virtual:playground-config";
...
const storageKey = `component-playground:${configHash(config)}`;
...
function App() {
  ...
  return (
    <div className={isPhone ? "pg-app pg-app--phone" : "pg-app"}>
      <TopBar
      ...
      <div className="pg-body">
        {isPhone ? null : (
          <aside className="pg-panel pg-panel--tree">{tree}</aside>
        )}
        ...
        {isPhone ? null : (
          <aside className="pg-panel pg-panel--inspector">{inspector}</aside>
        )}
      </div>
          ...
          {sheetTab === "layers" ? (
            ...
            <>
              ...
              <div className="pg-sheet-actions">
                <button type="button" className="pg-button" onClick={resetAll}>
                  Reset all
                </button>
              </div>
            </>
